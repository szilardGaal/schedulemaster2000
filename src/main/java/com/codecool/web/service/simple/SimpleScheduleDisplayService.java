...
public class SimpleScheduleDisplayService {
    ...
    public SimpleScheduleDisplayService(ScheduleDisplayDao scheduleDisplayDao){
        this.scheduleDisplayDao = scheduleDisplayDao;
    }

    public ScheduleDisplayDto createScheduleDisplay(int schedule_id) throws SQLException{
        return new ScheduleDisplayDto(findByScheduleId(schedule_id), getAllTaskForSchedule(schedule_id));
    }
